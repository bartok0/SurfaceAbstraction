...
namespace SurfaceAbstraction
{
    class SurfaceAbstractionMain : public DX::IDeviceNotify
    {
    public:
        SurfaceAbstractionMain(std::shared_ptr<DX::DeviceResources> const& deviceResources);
        ~SurfaceAbstractionMain();
